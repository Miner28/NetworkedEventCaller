...
public static int ReadVariableInt(this byte[] array, int startIndex, out ulong result)
{
    ...
    {
        result = (ulong)((b & _0x0F) << 24 | array[startIndex + 1] << 16 | array[startIndex + 2] << 8 | array[startIndex + 3]);
        return 4;
    }
    else if (b == 0xF0)
    {
        result = (ulong)(array[startIndex + 1] << 24 | array[startIndex + 2] << 16 | array[startIndex + 3] << 8 | array[startIndex + 4]);
        return 5;
    }
    else if (b == 0xF8)
    {
        result = (ulong)(array[startIndex + 1]) << 32 | ((ulong)array[startIndex + 2]) << 24 | ((ulong)array[startIndex + 3]) << 16 | ((ulong)array[startIndex + 4]) << 8 | ((ulong)array[startIndex + 5]);
        return 6;
    }
    else if (b == 0xFC)
    {
        result = (ulong)(array[startIndex +1]) << 40 | ((ulong)array[startIndex + 2]) << 32 | ((ulong)array[startIndex + 3]) << 24 | ((ulong)array[startIndex + 4]) << 16 | ((ulong)array[startIndex + 5]) << 8 | ((ulong)array[startIndex + 6]);
        return 7;
    }
    else if (b == 0xFE)
    {
        result = (ulong)(array[startIndex + 1]) << 48 | ((ulong)array[startIndex + 2]) << 40 | ((ulong)array[startIndex + 3]) << 32 | ((ulong)array[startIndex + 4]) << 24 | ((ulong)array[startIndex + 5]) << 16 | ((ulong)array[startIndex + 6]) << 8 | ((ulong)array[startIndex + 7]);
        return 8;
    }
    else if (b == 0xFF)
    {
        result = (ulong)(array[startIndex + 1]) << 56 | ((ulong)array[startIndex + 2]) << 48 | ((ulong)array[startIndex + 3]) << 40 | ((ulong)array[startIndex + 4]) << 32 | ((ulong)array[startIndex + 5]) << 24 | ((ulong)array[startIndex + 6]) << 16 | ((ulong)array[startIndex + 7]) << 8 | ((ulong)array[startIndex + 8]);
        return 9;
    }
